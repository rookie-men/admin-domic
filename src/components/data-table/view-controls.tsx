...
interface ViewControlsProps<TData> {
  table: Table<TData>
}

export default function ViewControls<TData>({
  table,
}: ViewControlsProps<TData>) {
    ...
    <Popover modal>
      <PopoverTrigger asChild>
        <Button
          ...
          role='combobox'
          size='sm'
          className='focus:ring-ring ml-auto hidden h-8 focus:ring-1 focus:outline-hidden lg:flex'
          onPointerDown={(event) => {
            /**
