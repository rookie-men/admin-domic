...
export default function FilterControls<TData>({
  table,
  filterFields,
  debounceMs,
  shallow,
            ...
            <Popover>
              <PopoverTrigger asChild>
                <Button
                  ...
                  size='sm'
                  className={cn(
                    'focus:ring-ring h-8 w-full justify-start rounded text-left font-normal focus:ring-1 focus:outline-none',
              ...
              <PopoverContent
                ...
                onCloseAutoFocus={() => {
                  ...
                  if (inputElm)
                    (inputElm as HTMLInputElement).focus({
                      preventScroll: true,
                    })
                }}
              >
                {filter.operator === 'isBetween' ? (
                  ...
                  <Calendar
                    ...
                    onSelect={(date) => {
                      ...
                      setTimeout(() => {
                        const inputElm = document.querySelector(`#${inputId}`)
                        if (inputElm) (inputElm as HTMLInputElement).click()
                      }, 0)
                    }}
                    initialFocus
                  />
                  ...
                  return (
                    ...
                    >
                      ...
                      >
                        ...
                        <Popover>
                          <PopoverTrigger asChild>
                            <Button
                              ...
                              className='focus:ring-ring h-8 w-32 justify-between rounded focus:ring-1 focus:outline-hidden'
                              onPointerDown={(event) => {
                                const target = event.target
                                if (!(target instanceof Element)) return
                                if (target.hasPointerCapture(event.pointerId)) {
                          ...
                          <PopoverContent
                            ...
                            onCloseAutoFocus={() => {
                              ...
                              if (triggerElm) {
                                ;(triggerElm as HTMLButtonElement).focus({
                                  preventScroll: true,
                                })
                              }
                            }}
                                  ...
                                  {filterFields.map((field) => (
                                    <CommandItem
                                      ...
                                      onSelect={(value) => {
                                        ...
                                        if (triggerElm) {
                                          ;(
                                            triggerElm as HTMLButtonElement
                                          ).click()
                                        }
                                      }}
                                    >
                        ...
                        <Button
                          aria-label={`Remove filter ${(index + 1).toString()}`}
                          variant='outline'
                          size='icon'
